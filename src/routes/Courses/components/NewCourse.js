        ...
        <div className="col-xs-12 col-md-10">
          <div className="form-group">
            ...
            <div className="col-xs-10 col-md-6">
              <input type="text" className="form-control" onChange={(e) => this.setState({video_link: e.target.value})} />
            </div>
          </div>
          ...
          <div className="form-group">
            ...
            <div className="col-xs-10 col-md-6">
              <input type="text" className="form-control" onChange={(e) => this.setState({descriptionLesson: e.target.value})} />
            </div>
          </div>
        ...
        <div className="col-xs-12 col-md-10">
          ...
          <form className="form-horizontal">
            ...
            <div className="form-group">
              ...
              <div className="col-xs-10 col-md-6">
                <input type="text" className="form-control" onChange={(e) => this.setState({main_photo: e.target.value})} />
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div className="col-xs-10 col-md-6">
                <input type="text" className="form-control" onChange={(e) => this.setState({duration: e.target.value})} />
              </div>
            </div>
